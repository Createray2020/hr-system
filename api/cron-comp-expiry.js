// api/cron-comp-expiry.js
// cron entry:每天 01:00 跑(在 vercel.json crons 啟用)
//
// thin wrapper:將 supabase 包成 lib/comp-time/expiry-sweep.js 期望的 repo。
//
...
export default async function handler(req, res) {
  ...
  try {
    const result = await runCompExpirySweep(makeLeaveRepo(), today);
