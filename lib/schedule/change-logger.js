...
const CHANGE_TYPES = Object.freeze([
  ...
  'system_lock',
  'late_change',
  // C6-2 + C7-C13 預留:HR / 主管 announce / unlock / override
  'hr_override_wish_deadline',
  'hr_announce',
  'hr_unlock',
  'manager_announce',
  'manager_publish',
  // F3:公告撤回(published → approved)、單一值靠 changed_by 區辨角色
  // 對應 migration:2026_05_28_add_manager_unpublish_change_type.sql
  'manager_unpublish',
  // 2026-06:executive(admin/chairman/ceo)解鎖 locked period(locked → approved)
  // 對應 migration:2026_06_02_add_executive_unlock_change_type.sql
  'executive_unlock',
]);
